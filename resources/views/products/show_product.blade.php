...
<div class="breadcrumb">
    <h1>{{ __('translate.View_Product') }}</h1>
</div>
...
<div class="row" id="section_edit_product">
    <div class="col-lg-12 mb-3">
         ...
         <form @submit.prevent="Update_Product()">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="name"
                                placeholder="{{ __('translate.Enter_Name_Product') }}" v-model="product.name" readonly>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <v-select placeholder="{{ __('translate.Choose_Category') }}" v-model="product.category_id"
                                ...
                                :options="categories.map(categories => ({label: categories.name, value: categories.id}))" readonly>
                            </v-select>
            ...
            <div class="card mt-5">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 mb-3" v-if="product.type == 'is_service'">
                            <label for="type" >{{ __('translate.Product_Type') }} <span class="field_required">*</span></label>
                        ...
                        <div class="form-group col-md-4" v-if="product.type == 'is_single' || product.type == 'is_service'">
                            ...
                            <input type="text" class="form-control" id="price" placeholder="{{ __('translate.Enter_Product_Price') }}"
                                v-model="product.price" readonly>
            ...
            <div class="card mt-5" v-if="product.type == 'is_single' || product.type == 'is_service'">
                <div class="card-body">
                    <div class="row">
                        @foreach ($cookedProduct as $row)
                        {{-- @dd($row) --}}
                            @php
                                $pro = DB::table('products')->where('id',$row->child_product_id)->first();
                                $unitt = DB::table('units')->where('id',$row->purchase_unit_id)->first();
                            @endphp
                            <div class="form-group col-md-6">
                                <label for="name">{{ __('translate.Product_Name') }} <span
                                        class="field_required">*</span></label>
                                <input type="text" class="form-control" id="name"
                                    placeholder="{{ __('translate.Enter_Name_Product') }}" value="{{ $pro->name }}" readonly>
                                <span class="error" v-if="errors && errors.name">
                                    @{{ errors.name[0] }}
                                </span>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="name">{{ __('translate.Product_Quantity') }} <span
                                        class="field_required">*</span></label>
                                <input type="text" class="form-control" id="name"
                                    placeholder="{{ __('translate.Enter_Name_Product') }}" value="{{ $row->quantity }}{{ $unitt->name }}" readonly>
                                <span class="error" v-if="errors && errors.name">
                                    @{{ errors.name[0] }}
                                </span>
                            </div>
