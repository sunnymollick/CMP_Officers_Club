                    ...
                    >
                        <ul class="list-group">
                            ...
                            @can('products_add')
                                <li>
                                    @include('components.sidebar.child-navitem', [
                                        'href'=>'/products/service_product_calculation',
                                        'title'=> __('translate.CookableProduct')
                                    ])
                                </li>
                            @endcan
                            @can('print_labels')
                        ...
                        <ul class="list-group">
                           ...
                           {{-- @can('report_profit')
                            ...
                            @can('purchase_reports')
                                <li>
                                    @include('components.sidebar.child-navitem', [
                                        'href'=>'/reports/purchase_report_2',
                                        'title'=> __('translate.CategoryWisePurchaseReport')
                                    ])
                                </li>
                            @endcan
