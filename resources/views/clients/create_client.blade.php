            ...
            <form @submit.prevent="Create_Client()">
                <div class="card-body">
                    <div class="row">
                        ...
                        <!-- Yearly Subscription -->
                        <div class="form-group col-md-6">
                            <label for="yearlySubscription">{{ __('translate.Yearly_Subscription') }}</label>
                            <input type="number" v-model="client.yearlySubscription" class="form-control" id="yearlySubscription" placeholder="{{ __('translate.Enter_Yearly_Subscription') }}">
                            <span class="error" v-if="errors && errors.yearlySubscription">
                                @{{ errors.yearlySubscription[0] }}
                            </span>
                        </div>

                        <!-- Refundable Amount (If any) -->
                        <div class="form-group col-md-6">
                            <label for="refundableAmount">{{ __('translate.Refundable_Amount_If_Any') }}</label>
                            <input type="number" v-model="client.refundableAmount" class="form-control" id="refundableAmount" placeholder="{{ __('translate.Enter_Refundable_Amount') }}">
                            <span class="error" v-if="errors && errors.refundableAmount">
                                @{{ errors.refundableAmount[0] }}
                            </span>
                        </div>
        ...
        methods: {
            ...
            changeChild4Photo(e){
             ...
             Create_Client() {
                ...
                self.data.append("Emergency_Contact_Number", self.client.Emergency_Contact_Number);
                ...
                self.data.append("yearlySubscription", self.client.yearlySubscription);
                self.data.append("refundableAmount", self.client.refundableAmount);
