        ...
        Route::middleware(['auth', 'Is_Active'])->group(function () {
            ...
            // Route::prefix('inventory')->group(function() {
                ...
                Route::prefix('reports')->group(function() {
                    ...
                    Route::get('purchase_report_2', 'ReportController@purchase_report_2')->name('purchase_report_2');


                    Route::post('categoryMonthlyPurchaseReport', 'ReportController@categoryMonthlyPurchaseReport')->name('categoryMonthlyPurchaseReport');
                ...
                Route::prefix('products')->group(function() {
                    ...
                    Route::get('service_product_calculation', 'ProductsController@service_product_calculation')->name('service_product_calculation');
                    ...
                    Route::post('storeServiceProductCalculation', 'ProductsController@storeServiceProductCalculation');
                ...
                //------------------------------- suppliers --------------------------\\
                 ...
                 Route::get('/customers/family-members/{id}','ClientController@getClientsFamilyMember');
